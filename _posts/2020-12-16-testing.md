...
In this post, I listed the challenges of testing robotics systems in fast-paced startups and shared my techniques to getting started with testing work.
However, my techniques don't address the challenges of using simulations and adopting automation because I still need more insights.
I plan to update them down the road.

In the meantime, let me know what you think by leaving comments below or messaging me on LinkedIn or Twitter!
