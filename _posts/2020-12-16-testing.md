...
## Ensuring reliability as an organization grows

> This section is work-in-progress.\
> Please check back for updates!

The real motivation behind testing is to ensure the reliability of products (e.g., RaaS) provided by an organization.
To that end, I share my insights on key testing, debugging, and observability practices to employ as an organization grows.
The practices discussed here partially address some of the unresolved challenges mentioned in the "Why is testing robotics systems hard?" section.

### 5-20 employees

At this stage, startups are likely to have fewer than 10 customers who are often also their design partners, and a handful of developers who are relentlessly building (and fixing) major components of the company's first product.
...
**Key Practices:**
- Setting up **continuous integration or nightly tests** (e.g., using GitHub Actions, GitLab CI/CD, Jenkins) with at least one **end-to-end test involving a high-fidelity simulator** (e.g., Gazebo) to smoke test quickly changing codebases.
- Setting up **internal communication channels** (e.g., Slack) and investing in a reliable **teleop solution** (e.g., MQTT, WebRTC) for quickly responding to critical incidents.
- Creating **metrics and dashboards** (e.g., Graphana/Prometheus) **to track business-critical measures** such as the number of deliveries/distance traveled, throughput/object knitted.

### 21-200 employees

Startups at this stage start expanding their customer base and scale their operations to deploy and handle, for example, more than 100 robots.
They have teams of developers improving the performance of core robotics algorithms to handle diverse environments of new customers, improving the overall user experience by having better onboard and/or desktop user interfaces, and an infrastructure or DevOps team to scale operations.
Large changes become less likely, and boundaries between development teams/ownership become apparent.

**Key Practices:**

- Employing narrow integration tests and contract tests (e.g., using pytest, Googletest) with fakes and mocks and adding them to continuous integration to test the integration of components built by individual teams.
...
In this post, I have listed the challenges of testing robotics systems in fast-paced startups, shared my techniques for getting started with testing work, and provided insights on key practices for ensuring reliability as an organization grows.
...
- _2023/06/_: Added the "Ensuring reliability as an organization grows" section
