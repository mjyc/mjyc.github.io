...
Typically, companies at this stage is not considered as startups but robotics being experinetal technology, robotics companies are still considered as startups at this stage.
However, I don't have any firsthand experience with companies at this size and in fact only knows a handful of robotics companies at this stage, e.g., large autonomous vehicle companies like Waymo, Cruise, Aurora, Zoox.
One interesting trends I've seen is custom hardware to accelerate computations unique to their needs but that's just spectulation.
Will update here after gaining more experience with companies at this stage, one day.
