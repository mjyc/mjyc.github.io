...
When thinking about working on creating test code, I get overwhelmed because I feel like so many things can go wrong and I can only write so much test code.
So I use this matrix to prioritize tasks. (adopted eigenhaur matrix)

<link rel="shortcut icon" type="image/png" href="/assets/imgs/mcmatrix.svg">

<figure>
  <img src="/assets/imgs/mcmatrix.svg" width="480px">
