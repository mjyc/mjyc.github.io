...
<br>[^2] For more insights, check out [Overcoming Pitfalls in Behavior Tree Design](http://www.gameaipro.com/GameAIPro3/GameAIPro3_Chapter09_Overcoming_Pitfalls_in_Behavior_Tree_Design.pdf).
...
<br>[^4] JavaScript isn't roboticists' favorite, which is [understandable](https://youtu.be/Uo3cL4nrGOk), but the [frontend community offers amazing DX](https://twitter.com/swyx/status/1505547960808972295).
...
<br>[^6] [awesome-cloud-robotics](https://github.com/Airbotics/awesome-cloud-robotics) gives some ideas.
...
<br>[^10] Check out [NOCODE.TECH](https://www.nocode.tech/) and [NodeCodeList](https://nocodelist.co/).