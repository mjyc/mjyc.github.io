...
What's also interesting to me is the rise of [No-code](https://en.wikipedia.org/wiki/No-code_development_platform)[^9] in the last ~5 years.
...
<br>[^9] For examples, check [NOCODE.TECH](https://www.nocode.tech/) and [NodeCodeList](https://nocodelist.co/).